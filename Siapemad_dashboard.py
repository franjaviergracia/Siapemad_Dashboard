...
def cargar_datos_consumo(file_path):
...
excel_files_consumo = {
    "Dataset 1": "consumos/dataset_consumo_YH-00049797.xlsx",
    "Dataset 2": "consumos/dataset_consumo_YH-00052712.xlsx",
    "Dataset 3": "consumos/dataset_consumo_YH-00052886.xlsx",
    "Dataset 4": "consumos/dataset_consumo_YH-00052887.xlsx",
    "Dataset 5": "consumos/dataset_consumo_YH-00052900.xlsx",
    "Dataset 6": "consumos/dataset_consumo_YH-00052916.xlsx",
    "Dataset 7": "consumos/dataset_consumo_YH-00052918.xlsx",
    "Dataset 8": "consumos/dataset_consumo_YH-00052920.xlsx",
    "Dataset 9": "consumos/dataset_consumo_YH-00052926.xlsx",
    "Dataset 10": "consumos/dataset_consumo_YH-00052927.xlsx",
    "Dataset 11": "consumos/dataset_consumo_YH-00052930.xlsx",
    "Dataset 12": "consumos/dataset_consumo_YH-00052931.xlsx"

}

excel_files_actividad = {
    "Dataset 1": "actividades/YH-00049797.xlsx",
    "Dataset 2": "actividades/YH-00052886.xlsx",
    "Dataset 3": "actividades/YH-00052887.xlsx",
    "Dataset 4": "actividades/YH-00052916.xlsx",
    "Dataset 5": "actividades/YH-00052927.xlsx",
    "Dataset 6": "actividades/YH-00052931.xlsx",
}

# Obtener la selección del usuario desde el desplegable en la barra lateral
selected_file_consumo = st.sidebar.selectbox(
    "Seleccione el dataset de consumo", list(excel_files_consumo.keys()))

# Botón para cargar el archivo seleccionado
cargar_datos_consumo_button = st.sidebar.button("Cargar datos")

# Verificar si se ha seleccionado un archivo diferente o se ha presionado el botón de carga de datos
if cargar_datos_consumo_button or "datos" not in st.session_state:
    # Cambiar el archivo de datos seleccionado
    st.session_state.selected_file = selected_file_consumo 
    file_path = excel_files_consumo[selected_file_consumo]
    print("la ruta es", file_path)
    # Cargar los datos desde el archivo Excel
    df = cargar_datos_consumo(file_path)
    # Guardar los datos en el estado de la sesión
    st.session_state.datos = df
 
else:
    # Utilizar los datos almacenados en el estado de la sesión
    df = st.session_state.datos


# Preparación de datos
# columnas_de_interes = ['Enchufe Salon', 'Luz Pasillo', 'Luz Cocina',
#                        'Luz Salon', 'Luz Dormitorio', 'Luz Bano', 'Luz Entrada']
...
df_unique['fecha'] = pd.to_datetime(df['fecha'])
...
selected_file_actividad = st.sidebar.selectbox(
    "Seleccione el dataset de actividad", list(excel_files_actividad.keys()))

# Botón para cargar el archivo seleccionado
cargar_datos_actividad_button = st.sidebar.button("Cargar datos actividad")

# Verificar si se ha seleccionado un archivo diferente o se ha presionado el botón de carga de datos
if cargar_datos_actividad_button or "actividad" not in st.session_state:
    # Cambiar el archivo de datos seleccionado
    st.session_state.selected_file_actividad = selected_file_actividad
    file_path_1 = excel_files_actividad[selected_file_actividad]
    print("la ruta es:", file_path_1)
    # Cargar los datos desde el archivo Excel
    df_act = cargar_datos_consumo(file_path_1)
    # Guardar los datos en el estado de la sesión
    st.session_state.actividad = df_act
 
else:
    # Utilizar los datos almacenados en el estado de la sesión
    df_act = st.session_state.actividad
...
activity_proc = Actividad(df_act).datos()
